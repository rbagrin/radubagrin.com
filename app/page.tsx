    ...
    <main className="flex-1 flex items-center">
      <div className="mx-auto w-full max-w-3xl px-6 py-24">
        ...
        <p className="mt-6 max-w-xl text-base leading-relaxed text-fg-muted">
          I build production systems around applied machine learning —
          from model integration to the infrastructure that keeps it
          running. This site doubles as a small workshop: each module
          below is a self-contained app I&apos;m building out over time.
        </p>
