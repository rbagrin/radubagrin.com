...
export const PESection = () => {
  ...
  return (
    <Card>
      <CardHeader
        title="Target 'Price to' Ratio calculator"
        subheader="Given the current stock price and valuation ratio, you can either set a target ratio to determine the price at which it would reach that ratio, or set a target price to calculate the corresponding valuation ratio"
      />
